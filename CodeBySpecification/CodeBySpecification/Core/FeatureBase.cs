...
namespace CodeBySpecification.Core
{
	...
	public class FeatureBase
	{
		...
		[When(@"I set ""(.*)"" as ""(.*)""")]
		[Then(@"I set ""(.*)"" as ""(.*)""")]
		public void SetTheValueOf(string variableKey, string variableValue)
		{
			dataRepoManager.AddData(variableKey, variableValue);
		}
		...
		[Given(@"I enter value ""(.*)"" to the ""(.*)""")]
		[When(@"I enter value ""(.*)"" to the ""(.*)""")]
		[Then(@"I enter value ""(.*)"" to the ""(.*)""")]
		[Given(@"Enter value ""(.*)"" to the ""(.*)""")]
		[When(@"Enter value ""(.*)"" to the ""(.*)""")]
		[Then(@"Enter value ""(.*)"" to the ""(.*)""")]
		public void EnterToThe(string value, string elementKey)
		{
			UiAutomationService.EnterTextTo(elementKey, value);
		}

		[Given(@"I enter value ""(.*)"" to element ""(.*)"" with the ""(.*)"" of ""(.*)""")]
		[When(@"I enter value ""(.*)"" to element ""(.*)"" with the ""(.*)"" of ""(.*)""")]
		[Then(@"I enter value ""(.*)"" to element ""(.*)"" with the ""(.*)"" of ""(.*)""")]
		[Given(@"Enter value ""(.*)"" to element ""(.*)"" with the ""(.*)"" of ""(.*)""")]
		[When(@"Enter value ""(.*)"" to element ""(.*)"" with the ""(.*)"" of ""(.*)""")]
		[Then(@"Enter value ""(.*)"" to element ""(.*)"" with the ""(.*)"" of ""(.*)""")]
		...
		[Given(@"""(.*)""st row, ""(.*)""nd column of table ""(.*)"" contains value ""(.*)""")]
		[When(@"""(.*)""st row, ""(.*)""nd column of table ""(.*)"" contains value ""(.*)""")]
		[Then(@"""(.*)""st row, ""(.*)""nd column of table ""(.*)"" contains value ""(.*)""")]
		[Given(@"""(.*)""st row, ""(.*)""rd column of table ""(.*)"" contains value ""(.*)""")]
		[When(@"""(.*)""st row, ""(.*)""rd column of table ""(.*)"" contains value ""(.*)""")]
		[Then(@"""(.*)""st row, ""(.*)""rd column of table ""(.*)"" contains value ""(.*)""")]
		[Given(@"""(.*)""st row, ""(.*)""th column of table ""(.*)"" contains value ""(.*)""")]
		[When(@"""(.*)""st row, ""(.*)""th column of table ""(.*)"" contains value ""(.*)""")]
		[Then(@"""(.*)""st row, ""(.*)""th column of table ""(.*)"" contains value ""(.*)""")]
		[Given(@"""(.*)""nd row, ""(.*)""st column of table ""(.*)"" contains value ""(.*)""")]
		[When(@"""(.*)""nd row, ""(.*)""st column of table ""(.*)"" contains value ""(.*)""")]
		[Then(@"""(.*)""nd row, ""(.*)""st column of table ""(.*)"" contains value ""(.*)""")]
		...
		[Given(@"""(.*)""nd row, ""(.*)""rd column of table ""(.*)"" contains value ""(.*)""")]
		[When(@"""(.*)""nd row, ""(.*)""rd column of table ""(.*)"" contains value ""(.*)""")]
		[Then(@"""(.*)""nd row, ""(.*)""rd column of table ""(.*)"" contains value ""(.*)""")]
		[Given(@"""(.*)""nd row, ""(.*)""th column of table ""(.*)"" contains value ""(.*)""")]
		[When(@"""(.*)""nd row, ""(.*)""th column of table ""(.*)"" contains value ""(.*)""")]
		[Then(@"""(.*)""nd row, ""(.*)""th column of table ""(.*)"" contains value ""(.*)""")]
		[Given(@"""(.*)""rd row, ""(.*)""st column of table ""(.*)"" contains value ""(.*)""")]
		[When(@"""(.*)""rd row, ""(.*)""st column of table ""(.*)"" contains value ""(.*)""")]
		[Then(@"""(.*)""rd row, ""(.*)""st column of table ""(.*)"" contains value ""(.*)""")]
		[Given(@"""(.*)""rd row, ""(.*)""nd column of table ""(.*)"" contains value ""(.*)""")]
		[When(@"""(.*)""rd row, ""(.*)""nd column of table ""(.*)"" contains value ""(.*)""")]
		[Then(@"""(.*)""rd row, ""(.*)""nd column of table ""(.*)"" contains value ""(.*)""")]
		...
		[Given(@"""(.*)""rd row, ""(.*)""th column of table ""(.*)"" contains value ""(.*)""")]
		[When(@"""(.*)""rd row, ""(.*)""th column of table ""(.*)"" contains value ""(.*)""")]
		[Then(@"""(.*)""rd row, ""(.*)""th column of table ""(.*)"" contains value ""(.*)""")]
		[Given(@"""(.*)""th row, ""(.*)""st column of table ""(.*)"" contains value ""(.*)""")]
		[When(@"""(.*)""th row, ""(.*)""st column of table ""(.*)"" contains value ""(.*)""")]
		[Then(@"""(.*)""th row, ""(.*)""st column of table ""(.*)"" contains value ""(.*)""")]
		[Given(@"""(.*)""th row, ""(.*)""nd column of table ""(.*)"" contains value ""(.*)""")]
		[When(@"""(.*)""th row, ""(.*)""nd column of table ""(.*)"" contains value ""(.*)""")]
		[Then(@"""(.*)""th row, ""(.*)""nd column of table ""(.*)"" contains value ""(.*)""")]
		[Given(@"""(.*)""th row, ""(.*)""rd column of table ""(.*)"" contains value ""(.*)""")]
		[When(@"""(.*)""th row, ""(.*)""rd column of table ""(.*)"" contains value ""(.*)""")]
		[Then(@"""(.*)""th row, ""(.*)""rd column of table ""(.*)"" contains value ""(.*)""")]
