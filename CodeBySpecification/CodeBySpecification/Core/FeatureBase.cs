...
namespace CodeBySpecification.Core
{
	...
	public class FeatureBase
	{
		...
		[Given(@"I enter ""(.*)"" to element ""(.*)"" with the ""(.*)"" of ""(.*)""")]
		[When(@"I enter ""(.*)"" to element ""(.*)"" with the ""(.*)"" of ""(.*)""")]
		[Then(@"I enter ""(.*)"" to element ""(.*)"" with the ""(.*)"" of ""(.*)""")]
		[Given(@"Enter ""(.*)"" to element ""(.*)"" with the ""(.*)"" of ""(.*)""")]
		[When(@"Enter ""(.*)"" to element ""(.*)"" with the ""(.*)"" of ""(.*)""")]
		[Then(@"Enter ""(.*)"" to element ""(.*)"" with the ""(.*)"" of ""(.*)""")]
